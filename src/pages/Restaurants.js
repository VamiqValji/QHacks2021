  ...
  return (
    ...
    <div className="component3">
      ...
      <form onSubmit = {submit} className = "restaurantsignup">
        ...
        <TextField  className = "fullName" id="fullName" label="Full Name" name = "fullName"/>
        <TextField className = "fullName"  id="restaurantName" label="Restaurant Name" />
        <TextField  className = "fullName" id="resPostalCode" label="Restaurant Postal Code" />
        <TextField  className = "fullName"  id="resAddress" label="Restaurant Address" />
